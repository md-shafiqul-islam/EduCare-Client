    ...
    <section className="bg-base-200 px-4 py-16">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="space-y-2">
          <h2 className="text-3xl md:text-4xl text-center font-bold text-primary mb-4">
            About Us
          </h2>
          <div className="space-y-5 text-base text-base-content leading-relaxed">
            ...
            <p>
              ...
              tutors and real progress tracking, EduCare ensures quality
              education reaches every home.
            </p>
            <p>
              We cover a wide range of subjects—Bangla, English, Math, Science,
              ICT, Quran, and even creative arts like Drawing and Web
              Development. Our approach combines modern tech with traditional
              values.
            </p>
          </div>
        </div>
